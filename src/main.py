...
def parse_arguments():
    ...
    parser.add_argument("story_file", type=str, help="Path to the user story markdown file")
    parser.add_argument(
        "--log-level",
        type=str,
    ...
    parser.add_argument(
        "--output-file", type=str, help="Path to save the output results (default: print to stdout)"
    )
    parser.add_argument(
        "--format",
        type=str,
    ...
    parser.add_argument(
        "--provider",
        type=str,
        choices=["deepseek", "openai", "claude", "flow-openai", "flow-bedrock"],
        default="deepseek",
...
def save_or_print_results(
    ...
    formatted_results = (
        format_results_json(results) if output_format == "json" else format_results_text(results)
    )
...
def format_results_json(results: dict[str, Any]) -> str:
    ...
    json_output["score"] = {"maturity": maturity_score, "invest": invest_score}
