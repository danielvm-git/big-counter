...
- **src/bcp/logger.py**: Custom logging with text and structured JSON formats
...
### Environment Setup
1. Run the idempotent setup script: `bash scripts/setup.sh`
2. Edit `.env` with your API keys (OpenAI and/or Anthropic)
